...
(function() {
    ...
    var _elm_lang$core$List$all = F2(function(isOkay, list) {
        return _elm_lang$core$Basics$not(
            A2(
                _elm_lang$core$List$any, function(_p2) {
                    return _elm_lang$core$Basics$not(
                        isOkay(_p2));
                },
                list));
    ...
    var _elm_lang$core$List$member = F2(function(x, xs) {
        return A2(
            _elm_lang$core$List$any, function(a) {
    ...
    var _elm_community$list_extra$List_Extra$greedyGroupsOfWithStep = F3(function(size, step, xs) {
    ...
    var _elm_community$list_extra$List_Extra$greedyGroupsOf = F2(function(size, xs) {
        return A3(_elm_community$list_extra$List_Extra$greedyGroupsOfWithStep, size, size, xs);
    });
    var _elm_community$list_extra$List_Extra$groupsOfWithStep = F3(function(size, step, xs) {
        var okayArgs = (_elm_lang$core$Native_Utils.cmp(size, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(step, 0) > 0);
        var xs$ = A2(_elm_lang$core$List$drop, step, xs);
        var group = A2(_elm_lang$core$List$take, size, xs);
    ...
    var _elm_community$list_extra$List_Extra$groupsOf = F2(function(size, xs) {
    ...
    var _elm_community$list_extra$List_Extra$isSuffixOf = F2(function(suffix, xs) {
        return A2(
    ...
    var _elm_community$list_extra$List_Extra$selectSplit = function(xs) {
        ...
        if (_p1.ctor === '[]') {
            ...
            return A2(
                ...
                A2(
                    _elm_lang$core$List$map, function(_p2) {
                        var _p3 = _p2;
                        return {
                            ctor: '_Tuple3',
    ...
    var _elm_community$list_extra$List_Extra$select = function(xs) {
        ...
        if (_p6.ctor === '[]') {
            ...
            return A2(
                ...
                A2(
                    _elm_lang$core$List$map, function(_p7) {
                        var _p8 = _p7;
                        return {
                            ctor: '_Tuple2',
                            _0: _p8._0,
    ...
    var _elm_community$list_extra$List_Extra$tailsHelp = F2(function(e, list) {
        var _p11 = list;
        if (_p11.ctor === '::') {
            var _p12 = _p11._0;
            return A2(
    ...
    var _elm_community$list_extra$List_Extra$isInfixOf = F2(function(infix, xs) {
        return A2(
    ...
    var _elm_community$list_extra$List_Extra$groupWhileTransitively = F2(function(cmp, xs$) {
        var _p13 = xs$;
        if (_p13.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                []);
    ...
    var _elm_community$list_extra$List_Extra$stripPrefix = F2(function(prefix, xs) {
    ...
    var _elm_community$list_extra$List_Extra$unfoldr = F2(function(f, seed) {
        var _p21 = f(seed);
    ...
    var _elm_community$list_extra$List_Extra$scanr1 = F2(function(f, xs$) {
        var _p22 = xs$;
        if (_p22.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                []);
    ...
    var _elm_community$list_extra$List_Extra$scanr = F3(function(f, acc, xs$) {
        var _p24 = xs$;
        if (_p24.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                [acc]);
    ...
    var _elm_community$list_extra$List_Extra$scanl1 = F2(function(f, xs$) {
        var _p26 = xs$;
        if (_p26.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                []);
    ...
    var _elm_community$list_extra$List_Extra$indexedFoldr = F3(function(func, acc, list) {
        var step = F2(function(x, _p27) {
            var _p28 = _p27;
            var _p29 = _p28._0;
            return {
                ctor: '_Tuple2',
    ...
    var _elm_community$list_extra$List_Extra$indexedFoldl = F3(function(func, acc, list) {
        var step = F2(function(x, _p30) {
            var _p31 = _p30;
            var _p32 = _p31._0;
            return {
                ctor: '_Tuple2',
    ...
    var _elm_community$list_extra$List_Extra$foldr1 = F2(function(f, xs) {
        var mf = F2(function(x, m) {
            return _elm_lang$core$Maybe$Just(function() {
                var _p33 = m;
    ...
    var _elm_community$list_extra$List_Extra$interweaveHelp = F3(function(l1, l2, acc) {
        interweaveHelp:
        while (true) {
            var _p35 = {
                ctor: '_Tuple2',
    ...
    var _elm_community$list_extra$List_Extra$interweave = F2(function(l1, l2) {
        return A3(
    ...
    var _elm_community$list_extra$List_Extra$isPermutationOf = F2(function(permut, xs) {
        return A2(
    ...
    var _elm_community$list_extra$List_Extra$isSubsequenceOf = F2(function(subseq, xs) {
        return A2(
            _elm_lang$core$List$member,
            subseq,
    ...
    var _elm_community$list_extra$List_Extra$filterNot = F2(function(pred, list) {
        return A2(
            _elm_lang$core$List$filter, function(_p44) {
                return _elm_lang$core$Basics$not(
                    pred(_p44));
            },
            list);
    });
    var _elm_community$list_extra$List_Extra$removeAt = F2(function(index, l) {
    ...
    var _elm_community$list_extra$List_Extra$setAt = F3(function(index, value, l) {
        if (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) {
            return _elm_lang$core$Maybe$Nothing;
        } else {
            var tail = _elm_lang$core$List$tail(
    ...
    var _elm_community$list_extra$List_Extra$updateIfIndex = F3(function(predicate, update, list) {
        return A2(
    ...
    var _elm_community$list_extra$List_Extra$updateAt = F3(function(index, update, list) {
    ...
    var _elm_community$list_extra$List_Extra$updateIf = F3(function(predicate, update, list) {
        return A2(
            _elm_lang$core$List$map, function(item) {
                return predicate(item) ? update(item) : item;
            },
            list);
    });
    var _elm_community$list_extra$List_Extra$replaceIf = F3(function(predicate, replacement, list) {
        return A3(
    ...
    var _elm_community$list_extra$List_Extra$findIndices = function(p) {
        return function(_p50) {
            return A2(
                ...
                A2(
                    _elm_lang$core$List$filter, function(_p51) {
                        var _p52 = _p51;
                        return p(_p52._1);
                    },
                    A2(
    ...
    var _elm_community$list_extra$List_Extra$find = F2(function(predicate, list) {
        find:
        while (true) {
            var _p54 = list;
            if (_p54.ctor === '[]') {
    ...
    var _elm_community$list_extra$List_Extra$lift2 = F3(function(f, la, lb) {
        return A2(
    ...
    var _elm_community$list_extra$List_Extra$lift3 = F4(function(f, la, lb, lc) {
        return A2(
            _elm_community$list_extra$List_Extra$andThen,
            la, function(a) {
                return A2(
    ...
    var _elm_community$list_extra$List_Extra$lift4 = F5(function(f, la, lb, lc, ld) {
        return A2(
            _elm_community$list_extra$List_Extra$andThen,
            la, function(a) {
                return A2(
    ...
    var _elm_community$list_extra$List_Extra$andMap = F2(function(fl, l) {
        return A3(
            _elm_lang$core$List$map2,
            F2(function(x, y) {
                return x(y);
    ...
    var _elm_community$list_extra$List_Extra$uniqueHelp = F3(function(f, existing, remaining) {
        uniqueHelp:
        while (true) {
            var _p57 = remaining;
            if (_p57.ctor === '[]') {
    ...
    var _elm_community$list_extra$List_Extra$uniqueBy = F2(function(f, list) {
        return A3(_elm_community$list_extra$List_Extra$uniqueHelp, f, _elm_lang$core$Set$empty, list);
    });
    var _elm_community$list_extra$List_Extra$unique = function(list) {
        return A3(_elm_community$list_extra$List_Extra$uniqueHelp, _elm_lang$core$Basics$identity, _elm_lang$core$Set$empty, list);
    };
    var _elm_community$list_extra$List_Extra$dropWhile = F2(function(predicate, list) {
        dropWhile:
        while (true) {
            var _p60 = list;
            if (_p60.ctor === '[]') {
    ...
    var _elm_community$list_extra$List_Extra$takeWhile = F2(function(predicate, list) {
        var _p61 = list;
        if (_p61.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                []);
    ...
    var _elm_community$list_extra$List_Extra$break = function(p) {
        return _elm_community$list_extra$List_Extra$span(function(_p63) {
            return _elm_lang$core$Basics$not(
                p(_p63));
        });
    };
    var _elm_community$list_extra$List_Extra$groupWhile = F2(function(eq, xs$) {
        var _p64 = xs$;
        if (_p64.ctor === '[]') {
            return _elm_lang$core$Native_List.fromArray(
                []);
    ...
    var _elm_community$list_extra$List_Extra$minimumBy = F2(function(f, ls) {
        var minBy = F2(function(x, _p67) {
            var _p68 = _p67;
            var _p69 = _p68._1;
            var fx = f(x);
            return (_elm_lang$core$Native_Utils.cmp(fx, _p69) < 0) ? {
                ctor: '_Tuple2',
                _0: x,
                _1: fx
            } : {
    ...
    var _elm_community$list_extra$List_Extra$maximumBy = F2(function(f, ls) {
        var maxBy = F2(function(x, _p72) {
            var _p73 = _p72;
            var _p74 = _p73._1;
            var fx = f(x);
            return (_elm_lang$core$Native_Utils.cmp(fx, _p74) > 0) ? {
                ctor: '_Tuple2',
                _0: x,
                _1: fx
            } : {
    ...
    var _elm_community$list_extra$List_Extra$init = function() {
        ...
        return A2(
            _elm_lang$core$List$foldr, function(_p80) {
                return A2(
                    F2(function(x, y) {
    ...
    var _elm_community$maybe_extra$Maybe_Extra$filter = F2(function(f, m) {
    ...
    var _elm_community$maybe_extra$Maybe_Extra$or = F2(function(ma, mb) {
        var _p5 = ma;
        if (_p5.ctor === 'Nothing') {
            return mb;
        } else {
    ...
    var _elm_community$maybe_extra$Maybe_Extra$next = _elm_lang$core$Maybe$map2(
        _elm_lang$core$Basics$flip(_elm_lang$core$Basics$always));
    var _elm_community$maybe_extra$Maybe_Extra$andMap = F2(function(f, x) {
        return A2(
    ...
    var _elm_community$maybe_extra$Maybe_Extra$mapDefault = F3(function(d, f, m) {
        var _p6 = m;
        if (_p6.ctor === 'Nothing') {
            return d;
        } else {
    ...
    _elm_community$maybe_extra$Maybe_Extra_ops['?'] = F2(function(mx, x) {
    ...
    var _elm_lang$core$Regex$Regex = {
        ctor: 'Regex'
    };
    ...
    var _elm_community$string_extra$String_Extra$rightOfBack = F2(function(pattern, string) {
        return A2(
            ...
            '',
            A2(
                _elm_lang$core$Maybe$map, function(_p0) {
                    return A3(
    ...
    var _elm_community$string_extra$String_Extra$leftOf = F2(function(pattern, string) {
        return A2(
            ...
            '',
            A2(
                _elm_lang$core$List$map, function(_p1) {
                    return A2(
                        _elm_lang$core$Maybe$withDefault,
                        '',
                        _elm_lang$core$Maybe$oneOf(function(_) {
                            return _.submatches;
                        }(_p1)));
                },
                A3(
        ...
        return _elm_lang$core$String$toLower(
            A4(
                ...
                A4(
                    _elm_lang$core$Regex$replace,
                    _elm_lang$core$Regex$All,
                    _elm_lang$core$Regex$regex('([A-Z])'), function(_p10) {
                        return A2(
        ...
        return _elm_lang$core$String$toLower(
            A4(
                ...
                A4(
                    _elm_lang$core$Regex$replace,
                    _elm_lang$core$Regex$All,
                    _elm_lang$core$Regex$regex('([a-z\\d])([A-Z]+)'), function(_p11) {
                        return A2(
                            _elm_lang$core$String$join,
                            '_',
                            A2(
                                _elm_lang$core$List$filterMap,
                                _elm_lang$core$Basics$identity, function(_) {
                                    return _.submatches;
                                }(_p11)));
                    },
                    _elm_lang$core$String$trim(string))));
    ...
    var _elm_community$string_extra$String_Extra$camelize = function(string) {
        return A4(
            _elm_lang$core$Regex$replace,
            _elm_lang$core$Regex$All,
            _elm_lang$core$Regex$regex('[-_\\s]+(.)?'), function(_p12) {
                var _p13 = _p12;
        ...
        return (_elm_lang$core$Native_Utils.cmp(
            ...
            A4(
                ...
                A2(
                    ...
                    '',
                    A2(
                        _elm_lang$core$List$map, function(_) {
                            return _.match;
                        },
                        A3(
                            _elm_lang$core$Regex$find,
    ...
    var _elm_community$string_extra$String_Extra$replace = F3(function(search, substitution, string) {
        return A4(
            ...
            _elm_lang$core$Regex$All,
            _elm_lang$core$Regex$regex(
                _elm_lang$core$Regex$escape(search)), function(_p16) {
                return substitution;
            },
            string);
    });
    var _elm_community$string_extra$String_Extra$changeCase = F2(function(mutator, word) {
        return A2(
            ...
            '',
            A2(
                _elm_lang$core$Maybe$map, function(_p17) {
                    var _p18 = _p17;
                    return A2(
    ...
    var _elm_community$string_extra$String_Extra$toTitleCase = function(ws) {
        var uppercaseMatch = A3(
            _elm_lang$core$Regex$replace,
            _elm_lang$core$Regex$All,
            _elm_lang$core$Regex$regex('\\w+'), function(_p19) {
        ...
        return A4(
            _elm_lang$core$Regex$replace,
            _elm_lang$core$Regex$All,
            _elm_lang$core$Regex$regex('^([a-z])|\\s+([a-z])'), function(_p20) {
                ...
                _elm_lang$core$String$trim(
                    A4(
                        ...
                        A4(
                            _elm_lang$core$Regex$replace,
                            _elm_lang$core$Regex$All,
                            _elm_lang$core$Regex$regex('[A-Z]'), function(_p21) {
                                return A2(
                                    _elm_lang$core$String$append,
                                    '-', function(_) {
                                        return _.match;
    ...
    var _elm_lang$core$Task$andMap = F2(function(taskFunc, taskValue) {
        return A2(
            _elm_lang$core$Task$andThen,
            taskFunc, function(func) {
                return A2(
                    _elm_lang$core$Task$andThen,
                    taskValue, function(value) {
                        return _elm_lang$core$Task$succeed(
                            func(value));
                    });
            });
    ...
    var _elm_lang$core$Task$onEffects = F3(function(router, commands, state) {
        return A2(
            _elm_lang$core$Task$map, function(_p3) {
                return {
                    ctor: '_Tuple0'
                };
            },
    ...
    var _elm_lang$core$Task$toMaybe = function(task) {
        return A2(
            _elm_lang$core$Task$onError,
            A2(_elm_lang$core$Task$map, _elm_lang$core$Maybe$Just, task), function(_p4) {
    ...
    var _elm_lang$core$Task$toResult = function(task) {
        return A2(
            _elm_lang$core$Task$onError,
            A2(_elm_lang$core$Task$map, _elm_lang$core$Result$Ok, task), function(msg) {
                return _elm_lang$core$Task$succeed(
    ...
    var _elm_lang$core$Task$perform = F3(function(onFail, onSuccess, task) {
        return _elm_lang$core$Task$command(
            _elm_lang$core$Task$T(
                A2(
                    _elm_lang$core$Task$onError,
                    A2(_elm_lang$core$Task$map, onSuccess, task), function(x) {
                        return _elm_lang$core$Task$succeed(
                            onFail(x));
                    })));
    });
            ...
            return A2(
                ...
                _elm_lang$core$Native_Scheduler.spawn(
                    A2(
                        ...
                        _p1,
                        A2(_elm_lang$core$Platform$sendToSelf, router, _p1))), function(id) {
                    return A3(
    ...
    var _elm_lang$core$Time$onSelfMsg = F3(function(router, interval, state) {
        ...
        if (_p7.ctor === 'Nothing') {
            ...
            return A2(
                _elm_lang$core$Task$andThen,
                _elm_lang$core$Time$now, function(time) {
                    return A2(
                        _elm_lang$core$Task$andThen,
                        _elm_lang$core$Task$sequence(
                            A2(
                                _elm_lang$core$List$map, function(tagger) {
                                    return A2(
    ...
    var _elm_lang$core$Time$onEffects = F3(function(router, subs, _p9) {
        ...
        var rightStep = F3(function(_p12, id, _p11) {
            ...
            return {
                ...
                _2: A2(
                    _elm_lang$core$Task$andThen,
                    _elm_lang$core$Native_Scheduler.kill(id), function(_p14) {
                        return _p13._2;
                    })
            };
        });
        ...
        return A2(
            _elm_lang$core$Task$andThen,
            killTask, function(_p20) {
                return A2(
                    _elm_lang$core$Task$andThen,
                    A3(_elm_lang$core$Time$spawnHelp, router, spawnList, existingDict), function(newProcesses) {
                        return _elm_lang$core$Task$succeed(
    ...
    var _elm_lang$virtual_dom$Native_VirtualDom = function() {
        ...
        function diffFacts(a, b, category) {
            ...
            for (var aKey in a) {
                ...
                if (!(aKey in b)) {
                    diff = diff || {};
                    diff[aKey] = (typeof category === 'undefined')
    ...
    var _elm_lang$keyboard$Keyboard$onSelfMsg = F3(function(router, _p0, state) {
        ...
        if (_p2.ctor === 'Nothing') {
            ...
            return A2(
                _elm_lang$core$Task$andThen,
                _elm_lang$core$Task$sequence(
                    A2(_elm_lang$core$List$map, send, _p2._0.taggers)), function(_p3) {
                    return _elm_lang$core$Task$succeed(state);
                });
        }
    });
    var _elm_lang$keyboard$Keyboard_ops = _elm_lang$keyboard$Keyboard_ops || {};
    _elm_lang$keyboard$Keyboard_ops['&>'] = F2(function(t1, t2) {
        return A2(
            _elm_lang$core$Task$andThen,
            t1, function(_p4) {
                return t2;
                    ...
                    return A2(
                        ...
                        _elm_lang$core$Process$spawn(
                            A3(
                                ...
                                category,
                                _elm_lang$keyboard$Keyboard$keyCode, function(_p7) {
                                    return A2(
    ...
    var _elm_lang$keyboard$Keyboard$subMap = F2(function(func, _p12) {
        ...
        return A2(
            ...
            _p13._0, function(_p14) {
                return func(
                    _p13._1(_p14));
            });
    });
    _elm_lang$core$Native_Platform.effectManagers['Keyboard'] = {
        pkg: 'elm-lang/keyboard',
        init: _elm_lang$keyboard$Keyboard$init,
        onEffects: _elm_lang$keyboard$Keyboard$onEffects,
        onSelfMsg: _elm_lang$keyboard$Keyboard$onSelfMsg,
        tag: 'sub',
        subMap: _elm_lang$keyboard$Keyboard$subMap
    };
    ...
    var _evancz$elm_http$Http$defaultSettings = {
        timeout: 0,
        onStart: _elm_lang$core$Maybe$Nothing,
        onProgress: _elm_lang$core$Maybe$Nothing,
        desiredResponseType: _elm_lang$core$Maybe$Nothing,
    ...
    var _evancz$elm_http$Http$url = F2(function(baseUrl, args) {
        var _p2 = args;
        if (_p2.ctor === '[]') {
            return baseUrl;
        } else {
    ...
    var _evancz$elm_http$Http$Request = F4(function(a, b, c, d) {
        return {
            verb: a,
            headers: b,
            url: c,
    ...
    var _evancz$elm_http$Http$Settings = F5(function(a, b, c, d, e) {
        return {
            timeout: a,
            onStart: b,
            onProgress: c,
    ...
    var _evancz$elm_http$Http$Response = F5(function(a, b, c, d, e) {
        return {
            status: a,
            statusText: b,
            headers: c,
    ...
    var _evancz$elm_http$Http$TODO_implement_blob_in_another_library = {
        ctor: 'TODO_implement_blob_in_another_library'
    };
    var _evancz$elm_http$Http$TODO_implement_file_in_another_library = {
    ...
    var _evancz$elm_http$Http$BodyFormData = {
        ctor: 'BodyFormData'
    };
    var _evancz$elm_http$Http$ArrayBuffer = {
        ctor: 'ArrayBuffer'
    };
    ...
    var _evancz$elm_http$Http$Empty = {
        ctor: 'Empty'
    };
    var _evancz$elm_http$Http$empty = _evancz$elm_http$Http$Empty;
    var _evancz$elm_http$Http$FileData = F3(function(a, b, c) {
        return {
            ctor: 'FileData',
            _0: a,
            _1: b,
    ...
    var _evancz$elm_http$Http$BlobData = F3(function(a, b, c) {
        return {
            ctor: 'BlobData',
            _0: a,
            _1: b,
    ...
    var _evancz$elm_http$Http$StringData = F2(function(a, b) {
        return {
            ctor: 'StringData',
            _0: a,
            _1: b
    ...
    var _evancz$elm_http$Http$RawNetworkError = {
        ctor: 'RawNetworkError'
    };
    var _evancz$elm_http$Http$RawTimeout = {
        ctor: 'RawTimeout'
    };
    var _evancz$elm_http$Http$BadResponse = F2(function(a, b) {
        return {
            ctor: 'BadResponse',
            _0: a,
            _1: b
    ...
    var _evancz$elm_http$Http$handleResponse = F2(function(handle, response) {
    ...
    var _evancz$elm_http$Http$NetworkError = {
        ctor: 'NetworkError'
    };
    var _evancz$elm_http$Http$Timeout = {
        ctor: 'Timeout'
    };
    ...
    var _evancz$elm_http$Http$fromJson = F2(function(decoder, response) {
    ...
    var _evancz$elm_http$Http$get = F2(function(decoder, url) {
        var request = {
            verb: 'GET',
            headers: _elm_lang$core$Native_List.fromArray(
                []),
    ...
    var _evancz$elm_http$Http$post = F3(function(decoder, url, body) {
        var request = {
            verb: 'POST',
            headers: _elm_lang$core$Native_List.fromArray(
                []),
    ...
    var _user$project$Utils$removeExtraNewLines = function(_p0) {
        return A3(
            _elm_community$string_extra$String_Extra$replace,
            '$^',
            '\r',
    ...
    var _user$project$Utils$dropHeaders = function(_p1) {
        return _elm_lang$core$String$concat(
            A2(
                _elm_lang$core$List$intersperse,
                '\n',
                A2(
                    _elm_community$list_extra$List_Extra$dropWhile, function(a) {
                        return A2(_elm_lang$core$String$contains, 'Produced', a) || (_elm_lang$core$Native_Utils.cmp(
                    ...
                    A2(
                        ...
                        1,
                        A2(
                            _elm_community$list_extra$List_Extra$dropWhile, function(_p2) {
                                return _elm_lang$core$Basics$not(
                                    A2(_elm_lang$core$String$contains, '***', _p2));
                            },
                            _elm_lang$core$String$lines(_p1))))));
    };
    var _user$project$Utils$wordsToChars = function(_p3) {
        return _elm_lang$core$List$concat(
            A2(
                _elm_lang$core$List$intersperse,
                _elm_lang$core$Native_List.fromArray(
    ...
    var _user$project$Utils$atLeast = F2(function(min, num) {
        return (_elm_lang$core$Native_Utils.cmp(num, min) > 0) ? num : min;
    });
    var _user$project$Utils$foldl2 = F4(function(f, acc, list1, list2) {
        foldl2:
        while (true) {
            var _p5 = {
                ctor: '_Tuple2',
            ...
            if (_p5._0.ctor === '[]') {
                ...
                if (_p5._1.ctor === '[]') {
                    ...
                    var _v2 = f,
                        _v3 = A3(f, _p5._0._0, _p5._1._0, acc),
                        _v4 = _p5._0._1,
                        _v5 = _p5._1._1;
                    f = _v2;
                    acc = _v3;
    ...
    var _user$project$TextFetch$wordsPerPage = 20;
    var _user$project$TextFetch$urls = _elm_lang$core$Native_Platform.outgoingPort(
        'urls', function(v) {
            return v;
        });
    var _user$project$TextFetch$pageSetter = _elm_lang$core$Native_Platform.outgoingPort(
        'pageSetter', function(v) {
            return [v._0, v._1];
        });
    var _user$project$TextFetch$Model = F4(function(a, b, c, d) {
        return {
            options: a,
            selectedOption: b,
            selectedText: c,
    ...
    var _user$project$TextFetch$init = A4(
        ...
        _elm_lang$core$Native_List.fromArray(
            [
                ...
                {
                    name: 'Pride and Perjudice',
                    url: '/books/pride.txt'
                },
                {
                    name: 'The Picture of Dorian Gray',
                    url: '/books/dorian.txt'
                }
            ]),
        _elm_lang$core$Maybe$Nothing,
        _elm_lang$core$Maybe$Nothing,
        _elm_lang$core$Maybe$Nothing);
    var _user$project$TextFetch$Option = F2(function(a, b) {
        return {
            url: a,
            name: b
        };
    });
    var _user$project$TextFetch$selectedOptionDecoder = A3(
        _elm_lang$core$Json_Decode$object2,
        _user$project$TextFetch$Option,
        A2(
            _elm_lang$core$Json_Decode$at,
            _elm_lang$core$Native_List.fromArray(
        ...
        A2(
            ...
            _elm_lang$core$Json_Decode$string));
    var _user$project$TextFetch$FetchPageSuccess = function(a) {
        return {
            ctor: 'FetchPageSuccess',
            _0: a
        };
    };
    var _user$project$TextFetch$subscriptions = F2(function(pageGetter, model) {
        return pageGetter(_user$project$TextFetch$FetchPageSuccess);
    });
    var _user$project$TextFetch$TurnPage = {
        ctor: 'TurnPage'
    };
    var _user$project$TextFetch$FetchFailure = function(a) {
        return {
            ctor: 'FetchFailure',
            _0: a
        };
    };
    var _user$project$TextFetch$FetchSuccess = function(a) {
        return {
            ctor: 'FetchSuccess',
            _0: a
        };
    };
    var _user$project$TextFetch$getText = function(file) {
        return A3(
            _elm_lang$core$Task$perform,
            _user$project$TextFetch$FetchFailure,
            _user$project$TextFetch$FetchSuccess,
            A2(
                _elm_lang$core$Task$map, function(_p0) {
                    return _user$project$Utils$words(
                        _user$project$Utils$removeExtraNewLines(
                            _user$project$Utils$dropHeaders(_p0)));
                },
                _evancz$elm_http$Http$getString(file)));
    };
    var _user$project$TextFetch$update = F2(function(msg, model) {
        var _p1 = msg;
        switch (_p1.ctor) {
        case 'Fetch':
            var _p2 = _p1._0;
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        selectedOption: _elm_lang$core$Maybe$Just(_p2)
                    }),
                _1: _user$project$TextFetch$getText(_p2.url),
        ...
        case 'FetchSuccess':
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        selectedText: _elm_lang$core$Maybe$Just(
                            A2(_elm_lang$core$Debug$log, 't', _p1._0))
                    }),
                _1: _user$project$TextFetch$urls(
                    A2(
                        _elm_lang$core$Maybe$withDefault,
                        A2(_user$project$TextFetch$Option, ' ', ' '),
                        model.selectedOption).url),
                _2: _elm_lang$core$Maybe$Nothing
            };
        case 'FetchPageSuccess':
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        page: _elm_lang$core$Maybe$Just(_p1._0 - 1)
                    }),
                _1: A3(
                    _elm_lang$core$Task$perform, function(_p3) {
                    ...
                    _elm_lang$core$Basics$identity,
                    _elm_lang$core$Task$succeed(_user$project$TextFetch$TurnPage)),
                _2: _elm_lang$core$Maybe$Nothing
            };
        case 'FetchFailure':
            return {
        ...
        default:
            var _p4 = {
                ctor: '_Tuple3',
                _0: model.selectedOption,
                _1: model.selectedText,
                _2: model.page
            };
            if (((_p4._0.ctor === 'Just') && (_p4._1.ctor === 'Just')) && (_p4._2.ctor === 'Just')) {
                ...
                return {
                    ...
                    _0: _elm_lang$core$Native_Utils.update(
                        model,
                        {
                            page: _elm_lang$core$Maybe$Just(_p5 + 1)
                        }),
                    _1: _user$project$TextFetch$pageSetter(
                        {
                            ctor: '_Tuple2',
                            _0: _p4._0._0.url,
                            _1: _p5 + 1
                    ...
                    _2: function() {
                        var newText = _user$project$Utils$wordsToChars(
                            A2(
                                _elm_lang$core$List$take,
                                _user$project$TextFetch$wordsPerPage,
                                A2(_elm_lang$core$List$drop, _p5 * _user$project$TextFetch$wordsPerPage, _p4._1._0)));
                        return (_elm_lang$core$Native_Utils.cmp(
                            _elm_lang$core$List$length(newText),
                            0) > 0) ? _elm_lang$core$Maybe$Just(newText) : _elm_lang$core$Maybe$Nothing;
                    }()
                };
            } else {
                return {
    ...
    var _user$project$TextFetch$Fetch = function(a) {
        return {
            ctor: 'Fetch',
            _0: a
        };
    };
    var _user$project$TextFetch$view = function(model) {
        return A2(
            ...
            _elm_lang$core$Native_List.fromArray(
                [
                    A2(
                        _elm_lang$html$Html_Events$on,
                        'change',
                        A2(_elm_lang$core$Json_Decode$map, _user$project$TextFetch$Fetch, _user$project$TextFetch$selectedOptionDecoder))
                ]),
            A2(
                _elm_lang$core$List$map, function(opt) {
                    return A2(
                        _elm_lang$html$Html$option,
                        _elm_lang$core$Native_List.fromArray(
                            [
                                _elm_lang$html$Html_Attributes$id(opt.url),
                                _elm_lang$html$Html_Attributes$value(opt.name)
                            ]),
                        _elm_lang$core$Native_List.fromArray(
                            [
    ...
    var _user$project$Typelm$charachterView = F2(function(isNext, character) {
        var _p0 = function() {
            var _p1 = character;
            switch (_p1.ctor) {
            case 'Correct':
        ...
        var children = function() {
            var _p2 = _elm_lang$core$Char$toCode($char);
            switch (_p2) {
            case 32:
                return _elm_lang$core$Native_List.fromArray(
                    [
    ...
    var _user$project$Typelm$calculateWpm = F4(function(listA, listB, startTime, currentTime) {
        var elapsedSeconds = _elm_lang$core$Time$inSeconds(currentTime) - _elm_lang$core$Time$inSeconds(startTime);
        var _p3 = A4(
            _user$project$Utils$foldl2,
            F3(function(a, b, _p4) {
                var _p5 = _p4;
                var _p7 = _p5._1;
                var _p6 = _p5._0;
            ...
            listB);
        var correct = _p3._0;
        var incorrect = _p3._1;
        return A2(
            _user$project$Utils$atLeast,
            0,
            _elm_lang$core$Basics$round((((correct + incorrect) / 5) - incorrect) / (elapsedSeconds / 60)));
    });
    var _user$project$Typelm$wordsPerPage = 50;
    var _user$project$Typelm$pageGetter = _elm_lang$core$Native_Platform.incomingPort('pageGetter', _elm_lang$core$Json_Decode$int);
    var _user$project$Typelm$Model = F5(function(a, b, c, d, e) {
        return {
            userText: a,
            displayedText: b,
            wpm: c,
    ...
    var _user$project$Typelm$TextFetchMsg = function(a) {
        return {
            ctor: 'TextFetchMsg',
            _0: a
        };
    };
    var _user$project$Typelm$Tick = function(a) {
        return {
            ctor: 'Tick',
            _0: a
        };
    };
    var _user$project$Typelm$StartFailed = {
        ctor: 'StartFailed'
    };
    var _user$project$Typelm$StartSucceed = function(a) {
        return {
            ctor: 'StartSucceed',
            _0: a
        };
    };
    var _user$project$Typelm$update = F2(function(msg, model) {
        var _p8 = msg;
        switch (_p8.ctor) {
        case 'CharKeyMsg':
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        userText: A2(
                            _elm_lang$core$List_ops['::'],
                            _elm_lang$core$Char$fromCode(_p8._0),
                            model.userText)
                    }),
                _1: _elm_community$maybe_extra$Maybe_Extra$isNothing(model.startTime) ? A3(
                    _elm_lang$core$Task$perform, function(_p9) {
                        return _user$project$Typelm$StartFailed;
                    },
                    _user$project$Typelm$StartSucceed,
                    _elm_lang$core$Time$now) : (_elm_lang$core$Native_Utils.eq(
                    _elm_lang$core$List$length(model.userText),
                    _elm_lang$core$List$length(model.displayedText)) ? A2(
                    _elm_lang$core$Platform_Cmd$map,
                    _user$project$Typelm$TextFetchMsg,
                    A3(
                        _elm_lang$core$Task$perform, function(_p10) {
                            return _elm_lang$core$Native_Utils.crash(
                                'Typelm',
                                {
                                    start: {
                        ...
                        _elm_lang$core$Basics$identity,
                        _elm_lang$core$Task$succeed(_user$project$TextFetch$TurnPage))) : _elm_lang$core$Platform_Cmd$none)
            };
        case 'KeyMsg':
            return _elm_lang$core$Native_Utils.eq(_p8._0, 8) ? {
                ctor: '_Tuple2',
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        userText: A2(
                            ...
                            _elm_lang$core$Native_List.fromArray(
                                []),
                            _elm_lang$core$List$tail(model.userText))
                    }),
                _1: _elm_lang$core$Platform_Cmd$none
            } : {
                ctor: '_Tuple2',
        ...
        case 'StartSucceed':
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    model,
                    {
                        startTime: _elm_lang$core$Maybe$Just(_p8._0)
                    }),
                _1: _elm_lang$core$Platform_Cmd$none
            };
        case 'StartFailed':
            ...
            if (_p11.ctor === 'Nothing') {
                ...
                return {
                    ...
                    _0: _elm_lang$core$Native_Utils.update(
                        ...
                        {
                            wpm: A4(
                                _user$project$Typelm$calculateWpm,
                                _elm_lang$core$List$reverse(model.userText),
                                model.displayedText,
                                _p11._0,
                                _p8._0)
                        }),
        ...
        default:
            var _p12 = A2(_user$project$TextFetch$update, _p8._0, model.textFetch);
            var newChildState = _p12._0;
            var childCmd = _p12._1;
            var selectedText = _p12._2;
            var newModel = function() {
                var _p13 = selectedText;
                if (_p13.ctor === 'Just') {
                    return _elm_lang$core$Native_Utils.update(
                        model,
                        {
                            userText: _elm_lang$core$Native_List.fromArray(
                                []),
                            displayedText: _p13._0,
                            wpm: 0,
                            startTime: _elm_lang$core$Maybe$Nothing
                        });
                } else {
            ...
            return {
                ...
                _0: _elm_lang$core$Native_Utils.update(
                    newModel,
                    {
                        textFetch: newChildState
                    }),
                _1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Typelm$TextFetchMsg, childCmd)
            };
        }
    });
    var _user$project$Typelm$KeyMsg = function(a) {
        return {
            ctor: 'KeyMsg',
            _0: a
        };
    };
    var _user$project$Typelm$CharKeyMsg = function(a) {
        return {
            ctor: 'CharKeyMsg',
            _0: a
        };
    };
    var _user$project$Typelm$subscriptions = function(model) {
        return _elm_lang$core$Platform_Sub$batch(
            _elm_lang$core$Native_List.fromArray(
                [
                    _elm_lang$keyboard$Keyboard$presses(_user$project$Typelm$CharKeyMsg),
                    _elm_lang$keyboard$Keyboard$downs(_user$project$Typelm$KeyMsg),
                    A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Typelm$Tick),
                    A2(
                        _elm_lang$core$Platform_Sub$map,
                        _user$project$Typelm$TextFetchMsg,
                        A2(_user$project$TextFetch$subscriptions, _user$project$Typelm$pageGetter, model.textFetch))
                ]));
    };
    var _user$project$Typelm$Incorrect = function(a) {
        return {
            ctor: 'Incorrect',
            _0: a
        };
    };
    var _user$project$Typelm$Correct = function(a) {
        return {
            ctor: 'Correct',
            _0: a
        };
    };
    var _user$project$Typelm$Neutral = function(a) {
        return {
            ctor: 'Neutral',
            _0: a
        };
    };
    var _user$project$Typelm$view = function(model) {
        var typed = A3(
            _elm_lang$core$List$map2,
            F2(function(a, b) {
                return _elm_lang$core$Native_Utils.eq(a, b) ? _user$project$Typelm$Correct(a) : _user$project$Typelm$Incorrect(a);
            }),
            model.displayedText,
            _elm_lang$core$List$reverse(model.userText));
        var typedLength = _elm_lang$core$List$length(typed);
        var untyped = A2(
            _elm_lang$core$List$map, function(x) {
                return _user$project$Typelm$Neutral(x);
            },
            A2(_elm_lang$core$List$drop, typedLength, model.displayedText));
        return A2(
            _elm_lang$html$Html$div,
            _elm_lang$core$Native_List.fromArray(
                [
                    _elm_lang$html$Html_Attributes$class('typelm-container')
                ]),
            _elm_lang$core$Native_List.fromArray(
                [
                    A2(
                        ...
                        _elm_lang$core$Native_List.fromArray(
                            [
                                _elm_lang$html$Html_Attributes$class('typelm-header')
                            ]),
                        _elm_lang$core$Native_List.fromArray(
                            [
                                _elm_lang$html$Html$text(
                                ...
                                A2(
                                    ...
                                    _user$project$Typelm$TextFetchMsg,
                                    _user$project$TextFetch$view(model.textFetch))
                            ])),
                    A2(
                        _elm_lang$html$Html$div,
                        _elm_lang$core$Native_List.fromArray(
                            [
                                _elm_lang$html$Html_Attributes$class('typelm-text')
                            ]),
                        A2(
                            _elm_lang$core$List$indexedMap,
                            F2(function(i, x) {
                                return A2(
                                    _user$project$Typelm$charachterView,
                                    _elm_lang$core$Native_Utils.eq(i, typedLength),
                                    x);
                            }),
                            A2(_elm_lang$core$Basics_ops['++'], typed, untyped)))
                ]));
    };
    var _user$project$Typelm$main = {
        main: _elm_lang$html$Html_App$program(
            {
                init: _user$project$Typelm$init,
                view: _user$project$Typelm$view,
                update: _user$project$Typelm$update,
                subscriptions: _user$project$Typelm$subscriptions
            })
    };

    var Elm = {};
    Elm['Typelm'] = Elm['Typelm'] || {};
    _elm_lang$core$Native_Platform.addPublicModule(Elm['Typelm'], 'Typelm', typeof _user$project$Typelm$main === 'undefined' ? null : _user$project$Typelm$main);
