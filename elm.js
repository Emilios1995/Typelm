...
var _user$project$Utils$atLeast = F2(
	function (min, num) {
		return (_elm_lang$core$Native_Utils.cmp(num, min) > 0) ? num : min;
	});
var _user$project$Utils$foldl2 = F4(
	function (f, acc, list1, list2) {
		foldl2:
		while (true) {
			var _p5 = {ctor: '_Tuple2', _0: list1, _1: list2};
			if (_p5._0.ctor === '[]') {
				return acc;
			} else {
				if (_p5._1.ctor === '[]') {
...
var _user$project$TextFetch$Model = F4(
	function (a, b, c, d) {
		return {options: a, selectedOption: b, selectedText: c, page: d};
	});
var _user$project$TextFetch$init = A4(
	...
	_elm_lang$core$Maybe$Nothing,
	_elm_lang$core$Maybe$Nothing);
var _user$project$TextFetch$Option = F2(
	function (a, b) {
		return {url: a, name: b};
	});
...
var _user$project$TextFetch$FetchPageSuccess = function (a) {
	return {ctor: 'FetchPageSuccess', _0: a};
};
var _user$project$TextFetch$subscriptions = F2(
	function (pageGetter, model) {
		return pageGetter(_user$project$TextFetch$FetchPageSuccess);
	});
var _user$project$TextFetch$TurnPage = {ctor: 'TurnPage'};
...
var _user$project$TextFetch$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Fetch':
			...
			default:
				var _p4 = {ctor: '_Tuple3', _0: model.selectedOption, _1: model.selectedText, _2: model.page};
				if (((_p4._0.ctor === 'Just') && (_p4._1.ctor === 'Just')) && (_p4._2.ctor === 'Just')) {
					...
					return {
						...
						_1: _user$project$TextFetch$pageSetter(
							{ctor: '_Tuple2', _0: _p4._0._0.url, _1: _p5 + 1}),
						_2: function () {
...
var _user$project$Typelm$charachterView = F2(
	function (isNext, character) {
		var _p0 = function () {
			var _p1 = character;
			switch (_p1.ctor) {
				case 'Correct':
					return {ctor: '_Tuple2', _0: 'correct', _1: _p1._0};
				case 'Incorrect':
					return {ctor: '_Tuple2', _0: 'incorrect', _1: _p1._0};
				default:
					return {ctor: '_Tuple2', _0: 'neutral', _1: _p1._0};
			}
		}();
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							{ctor: '_Tuple2', _0: 'next', _1: isNext}
						]))
				]),
			children);
	});
var _user$project$Typelm$calculateWpm = F4(
	function (listA, listB, startTime, currentTime) {
		...
		var _p3 = A4(
			...
			F3(
				function (a, b, _p4) {
					...
					var _p7 = _p5._1;
					var _p6 = _p5._0;
					return _elm_lang$core$Native_Utils.eq(a, b) ? {ctor: '_Tuple2', _0: _p6 + 1, _1: _p7} : {ctor: '_Tuple2', _0: _p6, _1: _p7 + 1};
				}),
...
var _user$project$Typelm$Model = F5(
	function (a, b, c, d, e) {
		return {userText: a, displayedText: b, wpm: c, startTime: d, textFetch: e};
	});
var _user$project$Typelm$TextFetchMsg = function (a) {
	return {ctor: 'TextFetchMsg', _0: a};
};
var _user$project$Typelm$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Typelm$StartFailed = {ctor: 'StartFailed'};
var _user$project$Typelm$StartSucceed = function (a) {
	return {ctor: 'StartSucceed', _0: a};
};
var _user$project$Typelm$update = F2(
	function (msg, model) {
		var _p8 = msg;
		switch (_p8.ctor) {
			case 'CharKeyMsg':
...
var _user$project$Typelm$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Typelm$init, view: _user$project$Typelm$view, update: _user$project$Typelm$update, subscriptions: _user$project$Typelm$subscriptions})
};
