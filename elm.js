...
var _user$project$Typelm$Model = F2(
	function (a, b) {
		return {text: a, userText: b};
	});
						...
						model,
						{
							userText: A2(
								...
								_elm_lang$core$Char$fromCode(
									A2(_elm_lang$core$Debug$log, 'code', _p3._0)),
								model.userText)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyMsg':
				return _elm_lang$core$Native_Utils.eq(_p3._0, 8) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
...
var _user$project$Typelm$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _user$project$Typelm$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$Typelm$getText = function (file) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Typelm$FetchFail,
		_user$project$Typelm$FetchSucceed,
		A2(
			_elm_lang$core$Task$map,
			function (_p4) {
				return A2(
...
var _user$project$Typelm$init = {
	ctor: '_Tuple2',
	_0: {
		text: _elm_lang$core$String$toList('Hola como Estas'),
		userText: _elm_lang$core$String$toList('')
	},
	_1: _user$project$Typelm$getText('test.txt')
};
...
var _user$project$Typelm$view = function (model) {
	...
	var untyped = A2(
		...
		A2(_elm_lang$core$List$drop, typedLength, model.text));
	return A2(
